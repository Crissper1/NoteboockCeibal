...
public class ejer3ro {
    ...
    if(m=='F'){
      ...
      if(cM.equals("1")){
        valorConver=(vN * 5/9) - 32;
        m1='C';
      }
        //Fahrenheit a Kelvin
      if(cM.equals("2")){
        valorConver= (vN + 459 * 5/9);
        m1='K';
      }
    }
    if(m=='K'){
      ...
      //Kelvin a Fahrenheit
      if(cM.equals("2")){
        valorConver= (vN - 273 * 9/5 + 32);
        m1='F';
      } 
    }
      System.out.println(vN+"°"+m+ " son "+valorConver+"°"+m1);
